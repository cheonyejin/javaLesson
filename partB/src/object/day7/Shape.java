...
public class Shape {    
		...
		public static final int MAX_WIDTH=100;    //상수 //final은 처음 정의된 값이 변경되지 않는다 .
		// 도형의ㅏ 너비가Nax_WITDT를 넘으면 도화지가 작아서 못그림, 둥 가쥰울 종허눈 얘시
		// 상수는 상속의 의미가 없습니다 
		...
		//기본생성자  : 커스텀 생성자가 있을때는 직접 정의해야한다 
		public Shape() {
			System.out.println("새로운 도형이 만들어졌습니다.초기화 필요합니다.");
		}
	
		// 인스턴스 필드값 초기화하는 커스텀생성자
