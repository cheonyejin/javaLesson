...
public class B07ConstrucetorExam {
     ...
     */
        ...
        System.out.println("message==str2 ? "+ (message==str2));     //단,srt2는  new 연산으로 생성된 객체는 언제나 메모리 새로 할당 =>false
        ...
        Scanner sc =new Scanner(System.in);     // InputStream 클래스로 만들어진 객체 System.in을 생성자 인자로 하여 객체를 생성
                                                // System.in은 키보드 입력을 원시적인 방식으로 처리하기 때문에
        ...
        System.out.println("위의 입력 테스트에서 nextInt 또는 nextDouble 은 엔터처리를 안하므로 다음에 나오는 newLine 으로 자동 저장");
